...
public class Main {
	...
	private static void insert(String timeStamp, String packetLength, String isIP, String ipSource,
		...
		String insert = "INSERT INTO golubev.dump_all(" + Const.TIME_STAMP + "," + Const.PACKET_LENGTH + "," + Const.IS_IP
	...
	private static Connection getdbConnection() throws SQLException, ClassNotFoundException {
		String url = "jdbc:mysql://localhost/golubev?useUnicode=true&serverTimezone=UTC";
